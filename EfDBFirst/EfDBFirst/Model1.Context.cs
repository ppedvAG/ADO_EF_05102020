...
namespace EfDBFirst
{
    ...
    public partial class NORTHWNDEntities : DbContext
    {
        ...
        public virtual ObjectResult<GetTenMostExpensiveProducts_Result> GetTenMostExpensiveProducts()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetTenMostExpensiveProducts_Result>("GetTenMostExpensiveProducts");
        }
    }
}
